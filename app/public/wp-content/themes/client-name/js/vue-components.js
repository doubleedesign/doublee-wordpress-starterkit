...
const themeUrl = '/wp-content/themes/client-name';
...
Vue.createApp({
	components: {
		SiteNavigation: Vue.defineAsyncComponent(() => loadModule(`${themeUrl}/components/layout/header/site-navigation.vue`, vueSfcLoaderOptions)),
	},
	template: '',
	compilerOptions: {},
